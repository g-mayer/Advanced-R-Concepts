...
The slide shape is maintained by the density plot, however, the graph is more rounded than before. Also, the y axis only goes to 0.5 instead of 1. Finally, the x-axis only goes from -1 to 1, unlike the original graph that went from -2 to 2.
...
Between 7.5% and 8% of the points are rejected when using the rslide.
