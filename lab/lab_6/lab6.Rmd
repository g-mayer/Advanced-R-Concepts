...
Previously, the subtotal was being raised to the exponent of the percent_tax. I changed to be multiplied by the percent_tax.
...
YOUR WRITTEN ANSWER GOES HERE:
The if statement's conditional expression was not correctly inclosed in parentheses. I fixed this by adding a ')'
...
YOUR WRITTEN ANSWER GOES HERE:
Tip was being calculated incorrectly by multiplying pre_tip by the default tax. I corrected this by multiplying the pretip times the percent tip.
...
YOUR WRITTEN ANSWER GOES HERE:
There was a missing comma that was supposed to separate the arguments in 'out'. I fixed this by adding the comma after tip. Also there was an eqaulity check instead of assignment when assigning the variable grand_total
